...
def get_cropped_image_if_2_eyes(image_path, image_base64_data):
    ...
    face_cascade_path = os.path.join(current_dir, 'open_cv', 'haarcascades', 'haarcascade_frontalface_default.xml')
    eye_cascade_path = os.path.join(current_dir, 'open_cv', 'haarcascades', 'haarcascade_eye.xml')
